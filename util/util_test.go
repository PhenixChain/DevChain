...
import (
	...
	_ "github.com/PhenixChain/devchain/system/crypto/secp256k1"
	_ "github.com/PhenixChain/devchain/system/dapp/coins/types"
...
func TestResetDatadir(t *testing.T) {
	cfg, _ := types.InitCfg("../cmd/autotest/chain33.toml")
